...
def test_all_commands():
    ...
    commands_to_test = [
        ...
        ("StepNextDie", lambda: __import__('actions.WPTestingActions', fromlist=['step_next_die']).step_next_die()),
        ("GoToDie", lambda: __import__('actions.WPTestingActions', fromlist=['go_to_die']).go_to_die(col=1, row=1)),
        ...
        ("AlignWafer",
         lambda: __import__('actions.WPTestingActions', fromlist=['align_wafer']).align_wafer(align_die_col=1,
                                                                                              align_die_row=1)),
        ("GoToContact", lambda: __import__('actions.WPTestingActions', fromlist=['go_to_contact']).go_to_contact()),
        ("GoToSeparation",
         lambda: __import__('actions.WPTestingActions', fromlist=['go_to_separation']).go_to_separation()),
        ...
        ("MoveChuckToWorkArea",
         lambda: __import__('actions.WPTestingActions', fromlist=['move_chuck_work_area']).move_chuck_work_area(
             work_area=0)),
        ("LocalMode", lambda: __import__('actions.WPTestingActions', fromlist=['local_state']).local_state()),
        ("GoToPreviousDie",
         lambda: __import__('actions.WPTestingActions', fromlist=['go_to_previous_die']).go_to_previous_die()),
        ("GetChuckPosition",
