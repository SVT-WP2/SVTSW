...
CREATE TYPE "main"."siteGeneralLocation" AS ENUM (
  'CERN_186_R_E10',
  'Prague',
  'LosAlamos',
  'BNL',
...
CREATE TABLE "main"."Wafer" (
  ...
  "dicingDate" date,
  "productionDate" date,
  "generallocation" main."siteGeneralLocation"
);

CREATE TABLE "main"."WaferLocation" (
  "waferId" integer NOT NULL,
  "generalLocation" main."siteGeneralLocation" NOT NULL,
...
CREATE TABLE "main"."TestSetup" (
  ...
  "location" main."siteGeneralLocation"
);
