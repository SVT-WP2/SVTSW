...
import { EpicWpProjectsStore } from '../epic-wp-projects.store'


export namespace EpicWpProjectsSelectors {

    export const selectFeature = createFeatureSelector<EpicWpProjectsStore.State>(EpicWpProjectsStore.FEATURE_NAME)
