...
import { EpicWpProjectAdminUpdateFormFactory } from './epic-wp-project-admin-update-form.factory'

import Form = EpicWpProjectAdminUpdateForm


@Component({
    selector: 'epic-wp-project-admin-update-form',
    templateUrl: 'epic-wp-project-admin-update-form.component.html',
    standalone: true,
    providers: [
        {
...
export class EpicWpProjectAdminUpdateFormComponent extends BaseFormWithFactoryComponent<Form.FormData, FormGroup<Form.FormGroupControls>>
    implements OnInit {
    ...
    protected readonly formFactory = inject(EpicWpProjectAdminUpdateFormFactory)
