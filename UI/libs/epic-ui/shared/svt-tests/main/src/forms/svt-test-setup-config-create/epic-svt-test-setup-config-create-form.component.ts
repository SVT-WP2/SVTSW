...
import { EpicSvtTestSetupConfigCreateFormFactory } from './epic-svt-test-setup-config-create-form.factory'
...
@Component({
    selector: 'epic-svt-test-setup-config-create-form',
    templateUrl: 'epic-svt-test-setup-config-create-form.component.html',
    standalone: true,
    providers: [
        {
...
export class EpicSvtTestSetupConfigCreateFormComponent extends BaseFormWithFactoryComponent<Form.FormData,
    ...
    protected readonly formFactory = inject(EpicSvtTestSetupConfigCreateFormFactory)
