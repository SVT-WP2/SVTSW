...
CREATE TABLE "main"."MOSAIXConfigList" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "name" varchar(100) UNIQUE NOT NULL
);
...
ALTER TABLE "main"."SLDOTestList" ADD FOREIGN KEY ("config") REFERENCES "main"."SLDOTestConfiguration" ("id");
...
ALTER TABLE "main"."MOSAIXTestConfiguration" ADD FOREIGN KEY ("configId") REFERENCES "main"."MOSAIXConfigList" ("id");
