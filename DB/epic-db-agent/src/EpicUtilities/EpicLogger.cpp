  ...
  , msgId_(0U)
{
  ...
  char *logFilePath = getenv("EPIC_DB_AGENT_LOG_FILE");
  if (logFilePath == nullptr)
    logFileRoot_ = "./Epic_db_agent";
  else
  ...
  char *logVer = getenv("EPIC_DB_AGENT_LOG_VERBOSITY");
  if (logVer != nullptr)
  {
...
//========================================================================+
bool EpicLogger::setLogVerbosityFile(uint32_t verbosity)
{
...
//========================================================================+
void EpicLogger::logError(std::string message, uint32_t severity)
{
...
//========================================================================+
void EpicLogger::logWarning(std::string message, uint32_t severity)
{
  if ((severity <= logVerbosity_) || (severity <= logVerbosityFile_))
  {
...
//========================================================================+
void EpicLogger::logInfo(std::string message, uint32_t severity)
{
  if ((severity <= logVerbosity_) || (severity <= logVerbosityFile_))
  {
...
//========================================================================+
void EpicLogger::log(const std::string type, const std::string message,
                     uint32_t severity)
{
  ...
  std::string logMsg = "";
  {
    ...
    if (severity <= logVerbosityFile_)
    {
      if (logFileName_ != desiredLogFile)
      {
        ...
        {
          std::cerr << "EpicLogger::log unable to create the file "
...
//========================================================================+
std::string EpicLogger::to_hex(uint32_t inValue) const
{
  std::stringstream ss;
...
//========================================================================+
std::string EpicLogger::to_hex(std::vector<uint32_t> &inVect) const
{
  std::string ss = " ";
  // for(auto itinVect : inVect) ss += EpicLogger::to_hex(inVect[i])+"\n";
  for (uint32_t i = 0; i < inVect.size(); ++i)
    ss += EpicLogger::to_hex(inVect[i]) + " ";
  return ss;
}

//========================================================================+
std::string EpicLogger::to_hex(std::vector<int> &inVect) const
{
  std::string ss = " ";
  // for(auto itinVect : inVect) ss += EpicLogger::to_hex(inVect[i])+"\n";
  for (uint32_t i = 0; i < inVect.size(); ++i)
...
//========================================================================+
std::string EpicLogger::to_dec(uint32_t inValue) const
{
  std::stringstream ss;
...
//========================================================================+
std::string EpicLogger::to_dec(std::vector<uint32_t> &inVect) const
{
  std::string ss = " ";
  // for(auto itinVect : inVect) ss += EpicLogger::to_hex(inVect[i])+"\n";
  for (uint32_t i = 0; i < inVect.size(); ++i)
    ss += EpicLogger::to_dec(inVect[i]) + " ";
  return ss;
}

//========================================================================+
std::string EpicLogger::to_dec_d(double inValue) const
{
  return std::to_string(inValue);
}

//========================================================================+
std::string EpicLogger::to_dec_d(std::vector<double> &inVect) const
{
  std::string ss = " ";
  for (uint32_t i = 0; i < inVect.size(); ++i)
  {
    ss += EpicLogger::to_dec_d(inVect[i]) + " ";
  }
  return ss;
}
