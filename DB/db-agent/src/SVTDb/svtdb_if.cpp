...
//========================================================================+
bool SvtDb_IF::addEnumValue(std::string type_name, std::string value)
{
  std::string cmd =
...
//========================================================================+
bool SvtDb_IF::insertWaferRecords(const dbWaferRecords &waferRecords)
{
  SimpleInsert insert;
...
//========================================================================+
int SvtDb_IF::getAllWafers(std::vector<dbWaferRecords> &wafers)
{
  wafers.clear();
  SimpleQuery query;
